...
If you want to use this extension, you need to add the `com.iseonline.quarkus:quarkus-dev-apps-k8s-parent` extension first to your build file.
...
----
<dependency>
    <groupId>com.iseonline.quarkus</groupId>
